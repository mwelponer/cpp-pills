...
//void function() {} // this is not working because function() is already declared in static.cpp
...
int main(int argc, char **argv)
{
	...
	/* this is not working 
	(undefined reference to s_nother) because s_another in static.cpp is declared static */
	//std::cout << "s_nother: " << s_nother << std::endl; 
